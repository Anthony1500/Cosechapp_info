...
public class editarfumigacion extends Fragment implements Response.Listener<JSONObject>,Response.ErrorListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        String urls="https://apps.indoamerica.edu.ec/selectfumigacioneditar.php?id="+id;
        View v;
    ...
    private void editar(){
        ...
        String url="https://apps.indoamerica.edu.ec/editarfumigacion.php?fecha="+tfecha.getText().toString()+"&hora="+thora.getText().toString()+"&invernadero="+invernadero.getText().toString()+"&tratamiento="+tratamiento.getText().toString()+"&encargado="+encargado.getText().toString()+"&id="+id;
