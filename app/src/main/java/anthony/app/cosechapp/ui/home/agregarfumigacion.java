...
int dia,mes,anio,hora,minuto;
    ...
    private void agregar(){
        ...
        String url="https://apps.indoamerica.edu.ec/agregarfumigacion.php?fecha="+tfecha.getText().toString()+"&hora="+thora.getText().toString()+"&invernadero="+invernadero.getText().toString()+"&tratamiento="+tratamiento.getText().toString()+"&encargado="+encargado.getText().toString();
